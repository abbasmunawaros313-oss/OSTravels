...
const processingService = {
  ...
  totalFee: "90 € (Visa Fee) + Service Charges", // Standard Schengen package fee
...
const embassyInfo = {
  title: "Embassy of Hungary (Representing Estonia)",
  address: "House No. 12, F-6/2, Islamabad, Pakistan",
  phone: "(051) 2276849",
  email: "consulate.isl@mfa.gov.hu",
  note: "The Embassy of Hungary represents Estonia for Schengen C-Visas in Pakistan."
};
...
const vfsInfo = {
  ...
  note: "This is the official partner where we will book your appointment to submit your Estonia visa file."
};

// --- Estonia-Specific FAQs ---
const faqs = [
  {
    q: "Is there an Embassy of Estonia in Pakistan?",
    a: "No, there is no Estonian Embassy or Consulate in Pakistan. For Schengen visas, Estonia is represented by the Embassy of Hungary in Islamabad. O.S. Travel & Tours will prepare your file for the Hungarian Embassy."
  },
  {
    q: "Can I get an Estonia e-visa?",
    a: "No. As Estonia is a Schengen country, Pakistani citizens must apply for a Schengen sticker visa, which requires an in-person appointment and biometric submission. There is no e-visa for this."
  },
  {
...
// --- Estonia/Schengen-Specific Reviews ---
const reviews = [
  {
    name: "Tariq A.",
    quote: "I wanted to visit Tallinn, Estonia. O.S. Travel knew exactly what to do and prepared my file for the Embassy of Hungary. The process was smooth and my visa was approved!",
    rating: 5
  },
  {
    name: "S. Malik",
    quote: "I highly recommend their Schengen file processing service. They are experts. I just had to show up at VFS for my appointment. Very professional.",
    rating: 5
  },
  {
    name: "The Javid Family",
    quote: "We used O.S. Travel for our Baltic trip. They processed all our applications via the Hungarian embassy for our Estonia visa. Everything was perfect.",
    rating: 5
  }
];
  ...
  return (
    ...
    >
      ...
      <motion.div variants={itemVariants} className="flex items-center gap-4 mb-8">
        <img
          src="https://flagcdn.com/w160/ee.png" // Estonia flag
          alt="Flag of Estonia"
      ...
      >
        <h2 className="text-3xl font-bold text-gray-800 mb-6 text-center">
          Why Choose O.S. Travel for Your <span className="text-blue-600">Estonia Visa</span>?
        </h2>
        <p className="text-lg text-gray-600 text-center mb-8 max-w-3xl mx-auto">
          As expert visa consultants, we know the correct procedure for an Estonia visa is via the Embassy of Hungary.
          <strong className="text-gray-800"> We deal in complete visa file processing and appointment scheduling</strong> to ensure your application is submitted to the right embassy, flawlessly.
        </p>
