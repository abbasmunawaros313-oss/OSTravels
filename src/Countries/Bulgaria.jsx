...
// --- Page Data ---
// Data based on official Schengen requirements, modeled on your other Schengen file processing pages.
...
const processingService = {
  ...
  processingTime: "15 to 25 Working Days (After Appointment)",
  ...
  serviceIncludes: [
    ...
    "Visa Appointment Scheduling (at VFS/Gerry's)",
...
const embassyInfo = {
  title: "Embassy of Bulgaria, Islamabad",
  address: "Diplomatic Enclave, Ramna V, Plot 6/11, Islamabad, Pakistan",
  phone: "0092 51 2600846",
  email: "Embassy.Islamabad@mfa.bg",
  note: "All visa applications are submitted through an external service provider (VFS/Gerry's)."
};

const vfsInfo = {
  title: "Bulgaria Visa Application Centre",
  address: "Park Road, Chak Shahzad, Islamabad (Likely VFS/Gerry's)",
  phone: "0900 07860 (VFS Helpline)",
  email: "N/A",
  note: "This is the official partner for submitting your application and biometrics."
};

// --- Bulgaria-Specific FAQs ---
const faqs = [
  {
    q: "Is Bulgaria part of the Schengen Area?",
    a: "Yes. As of March 31, 2024, Bulgaria is a full member of the Schengen Area. A Bulgarian visa is a Schengen visa, allowing travel to all 29 Schengen member states."
  },
  {
    q: "Can I get an e-visa or visa on arrival for Bulgaria?",
    a: "No. Pakistani citizens are not eligible for an e-visa or visa on arrival. You must apply for a sticker visa (Schengen visa) in advance through the file processing system."
  },
  {
    q: "What is the most important part of the Bulgaria visa application?",
    a: "Like all Schengen visas, the most important parts are your 'proof of funds' (strong bank statement) and your 'proof of rootedness' (strong ties to Pakistan, like a stable job, family, or property) to show you will return."
  }
];

// --- Bulgaria/Schengen-Specific Reviews ---
const reviews = [
  {
    name: "Zahid M.",
    quote: "I was planning a trip to the Black Sea coast. O.S. Travel handled my entire Schengen file for Bulgaria. Their service is the best in Islamabad. Got my visa smoothly.",
    rating: 5
  },
  {
    name: "A. Khan",
    quote: "I highly recommend their file processing service for Schengen. They arranged my appointment and all my bookings for my trip to Sofia. Very professional.",
    rating: 5
  },
  {
    name: "The Farooq Family",
    quote: "We used O.S. Travel for our family vacation to Bulgaria. They processed all 4 of our applications. The file was perfect, and the visa was approved. Thank you!",
    rating: 5
  }
];
  ...
  return (
    ...
    >
      ...
      <motion.div variants={itemVariants} className="flex items-center gap-4 mb-8">
        <img
          src="https://flagcdn.com/w160/bg.png" // Bulgaria flag
      ...
      >
        <h2 className="text-3xl font-bold text-gray-800 mb-6 text-center">
          Why Choose O.S. Travel for Your <span className="text-blue-600">Bulgaria Visa</span>?
        </h2>
        <p className="text-lg text-gray-600 text-center mb-8 max-w-3xl mx-auto">
          As Bulgaria is now a Schengen country, the application is complex. We are expert visa consultants in Islamabad.
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <ServiceCard
            ...
            desc="We secure the earliest possible visa appointment date for you at the application centre."
          />
          <ServiceCard
      ...
      <motion.div variants={itemVariants} className="text-center mt-10 text-sm text-gray-500">
        <p>Visa approval is at the sole discretion of the Embassy of Bulgaria. O.S. Travel & Tours provides expert file preparation services.</p>
      </motion.div>
