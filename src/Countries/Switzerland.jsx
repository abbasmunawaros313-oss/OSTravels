...
// --- Page Data ---
// Data fetched directly from ostravels.com/schengen-visa-file-processing/switzerland-visa/
...
const embassyInfo = {
  title: "Embassy of Switzerland, Islamabad",
  address: "Street 6, Diplomatic Enclave, G-5/4, Islamabad, Pakistan",
  phone: "(051) 2279315",
...
const vfsInfo = {
  title: "Switzerland Visa Application Centre (VFS Global)",
  address: "Park Road, Chak Shahzad, (Opposite CDA Park), Islamabad",
  phone: "0900 07860 (VFS Helpline)",
  email: "info.swissspk@vfshelpline.com",
  note: "This is the official partner for submitting your application and biometrics."
};

// --- Switzerland-Specific FAQs ---
const faqs = [
  {
    q: "Is Switzerland a Schengen country?",
    a: "Yes, Switzerland is a full member of the Schengen Area. A visa for Switzerland is a Schengen visa, which allows you to travel to all 29 member countries."
  },
  {
    q: "Can I apply for a Switzerland visa online?",
  ...
  {
    q: "Is a Police Clearance Certificate required for a Switzerland visa?",
    a: "Yes, your website lists a 'Police clearances' certificate as a required document for the Switzerland visa application. We will guide you on obtaining this."
  }
];

// --- Switzerland/Schengen-Specific Reviews ---
const reviews = [
  {
    name: "Omer N.",
    quote: "O.S. Travel is the best for Schengen visas. They prepared my entire file for my Switzerland (Interlaken) trip. I was so worried, but they handled everything. Got my visa!",
    rating: 5
  },
  {
    name: "Sana A.",
    quote: "I highly recommend their file processing service for my Zurich trip. They arranged my appointment and all my bookings. I just had to show up at VFS. Very professional.",
    rating: 5
  },
  {
    name: "The Khan Family",
    quote: "We used O.S. Travel for our family vacation to Switzerland. They processed all our applications. The file was perfect, and the visa was approved. Thank you!",
    rating: 5
  }
];
  ...
  return (
    ...
    >
      ...
      <motion.div variants={itemVariants} className="flex items-center gap-4 mb-8">
        <img
          src="https://flagcdn.com/w160/ch.png" // Switzerland flag
      ...
      >
        <h2 className="text-3xl font-bold text-gray-800 mb-6 text-center">
          Why Choose O.S. Travel for Your <span className="text-blue-600">Switzerland Visa</span>?
        </h2>
      ...
      <motion.div variants={itemVariants} className="text-center mt-10 text-sm text-gray-500">
        <p>Visa approval is at the sole discretion of the Embassy of Switzerland. O.S. Travel & Tours provides expert file preparation services.</p>
      </motion.div>
